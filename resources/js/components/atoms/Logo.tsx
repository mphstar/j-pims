    ...
    return (
        <div className="flex gap-2">
            ...
            <motion.div
                ...
                className="flex h-8 w-8 items-center justify-center rounded-xlshadow-lg shadow-cyan-500/30"
                aria-label="Logo"
            >
                <img className="aspect-square h-8 w-8" src="/favicon.ico" alt="JPIMS Logo" />
            </motion.div>
        </div>
    );
}
